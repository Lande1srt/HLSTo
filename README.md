...
其后端基于开源项目 [m3u8-downloader](https://github.com/llychao/m3u8-downloader)进行二次开发，且作修改以部署到 Linux 服务端下载转发到对应WebDAV服务器（现代网盘主流支持），避免本地下载再上传的尴尬处境。
且基于原来版本做了伪后缀混淆识别，某些视频网站将 m3u8 内的 ts 文件后缀改为 jpeg 文件与其他后缀，导致常规只识别 ts 文件后缀的下载器无法正常识别下载。
